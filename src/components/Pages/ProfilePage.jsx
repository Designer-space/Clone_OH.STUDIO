		...
		<>
			...
			<motion.div
				...
				<motion.section
					...
					className='w-full h-[50vh] md:h-[70vh] flex flex-col gap-10 items-center justify-center p-4'>
				...
				<motion.section
					...
					className='max-w-[1440px] mx-auto p-5 md:p-10'>
					<div className='grid md:grid-cols-2 gap-5 '>
						<img
							src={Profile_1}
							alt=''
							className='rounded-md object-cover max-h-[300px] md:max-h-[600px] w-full'
						/>
						<img
							src={Profile_2}
							alt=''
							className='hidden md:block rounded-md object-cover self-stretch'
						/>
					</div>
				</motion.section>
				<motion.section
					...
					className='flex flex-col justify-center my-10 md:my-36'>
					<p className='bg-accent-200/50 rounded-full px-3 py-1 w-min mx-auto'>
						About
					</p>
					<p className='text-fluid-sub-header leading-tight tracking-tight text-center mx-auto p-5 md:max-w-[700px]'>
				...
				<motion.section
					...
					className='max-w-[1240px] mx-auto flex flex-col justify-center my-10 md:my-36'>
					<p className='bg-accent-200/50 rounded-full px-3 py-1 w-min mx-auto'>
						Experience
					</p>
					<p className='text-fluid-sub-header leading-tight tracking-tight text-center mx-auto p-5 md:max-w-[700px]'>
				...
				<motion.section
					...
					className='max-w-[1240px] mx-auto flex flex-col justify-center mt-10 md:mt-36 mb-0'>
					<p className='bg-accent-200/50 rounded-full px-3 py-1 w-min mx-auto'>
						Clients
					</p>
					<p className='text-fluid-sub-header leading-tight tracking-tight text-center mx-auto p-5 md:max-w-[700px]'>
					...
					<div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 md:gap-custom-gap md:gap-y-10 lg:gap-y-16 my-20'>
						{companyWorkedWith.map((data, index) => {
							return (
								<div
									key={index}
									className={`${data.alt === "Here" ? "" : "invert"}`}>
