  ...
  return (
    ...
    <Navbar />
      <section className='w-full h-[50vh] md:h-[70vh] flex flex-col gap-10 items-center justify-center p-4 font-primary'>
        <h1 className='text-fluid-header font-medium'>Hey 👋🏼 I'm Oli</h1>
      </section>
      ...
      <section className="flex flex-col justify-center my-10 md:my-36">
        ...
        <p className='text-fluid-sub-header font-medium leading-tight word-spacing tracking-tight text-center mx-auto p-5 md:max-w-[700px]'>A freelance designer based in the UK. I combine my experience in product and brand to solve problems, tell stories, and create compelling experiences.</p>
      </section>
      <section className="max-w-[1240px] mx-auto flex flex-col justify-center my-10 md:my-36">
        ...
        <p className='text-fluid-sub-header font-medium leading-tight word-spacing tracking-tight text-center mx-auto p-5 md:max-w-[700px]'>Where I've worked</p>
      ...
      <section className="max-w-[1240px] mx-auto flex flex-col justify-center mt-10 md:mt-36 mb-0">
        ...
        <p className='text-fluid-sub-header font-medium leading-tight word-spacing tracking-tight text-center mx-auto p-5 md:max-w-[700px]'>Who I've worked with</p>
