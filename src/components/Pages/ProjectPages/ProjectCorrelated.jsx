	...
	return (
		<>
			...
			<div className='max-w-[1400px] mx-auto px-5 md:px-10 flex flex-col gap-8'>
				...
				<DoubleImg
					projectItem1={projectItem.img5_1}
					projectItem2={projectItem.img5_2}
				/>
				<SingleImage projectItem={projectItem.img6} />
				<DoubleImg
					projectItem1={projectItem.img7_1}
					projectItem2={projectItem.img7_2}
				/>
				<SingleImage projectItem={projectItem.img8} />
				<DoubleImg
					projectItem1={projectItem.img9_1}
					projectItem2={projectItem.img9_2}
				/>
			</div>
