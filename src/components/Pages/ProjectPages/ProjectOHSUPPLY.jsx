    ...
    <>
      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-10 flex flex-col gap-8">
        ...
        <div className="pointer-events-none select-none rounded-xl grid grid-cols-3 gap-6">
          <div className="">
            <img src={projectItem.img2_1} alt="" className='pointer-events-none select-none rounded-xl w-full h-full object-cover ' />
          </div>
          <div className="">
             <img src={projectItem.img2_2} alt="" className='pointer-events-none select-none rounded-xl w-full h-full object-cover ' />
          </div>
          <div className="">
             <img src={projectItem.img2_3} alt="" className='pointer-events-none select-none rounded-xl w-full h-full object-cover ' />
          </div>
        </div>
