...
const ProjectPaperstreet = ({ projectItem }) => {
	return (
		<>
			<ProjectHeader
			...
			<div className='max-w-[1400px] mx-auto px-5 md:px-10 flex flex-col gap-8'>
				...
				<DoubleImg
					projectItem1={projectItem.img4_1}
					projectItem2={projectItem.img4_2}
				/>
				...
				<DoubleImg
					projectItem1={projectItem.img8_1}
					projectItem2={projectItem.img8_2}
				/>
			</div>
...
export default ProjectPaperstreet;
